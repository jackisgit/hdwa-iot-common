...
// 统计已执行任务、正在执行任务、未执行任务数量
        log.info(String.format(this.poolName + " Going to shutdown. Executed tasks: {}, Running tasks: {}, Pending tasks: {}",
...
// 统计已执行任务、正在执行任务、未执行任务数量
        log.info(
                String.format(this.poolName + " Going to immediately shutdown. Executed tasks: {}, Running tasks: {}, Pending tasks: {}",
                        this.getCompletedTaskCount(), this.getActiveCount(), this.getQueue().size()));
    ...
    protected void afterExecute(Runnable r, Throwable t) {
        ...
        log.info(String.format(this.poolName
                        + "-pool-monitor: Duration: {} ms, PoolSize: {}, CorePoolSize: {}, Active: {}, Completed: {}, Task: {}, Queue: {}, LargestPoolSize: {}, MaximumPoolSize: {},KeepAliveTime: {}, isShutdown: %s, isTerminated: %s",
